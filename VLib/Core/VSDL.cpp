...
namespace V
{
    ...
    static bool SDL2_ProcessEvent(const SDL_Event* event)
    {
    ...
    static void SDL2_UpdateMousePosAndButtons()
    {
        ImGuiIO& io = ImGui::GetIO();
    ...
    static void SDL2_NewFrame(SDL_Window* window)
    {
         ImGuiIO& io = ImGui::GetIO();
    ...
    static bool SDL2_Init_IO(SDL_Window* window)
    {
        g_Window = window;
