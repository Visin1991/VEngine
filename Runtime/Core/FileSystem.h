...
namespace V
{
	...
	private:
		...
		static inline std::vector<std::string> m_supportedImageFormats;
		static inline std::vector<std::string> m_supportedAudioFormats;
		static inline std::vector<std::string> m_supportedModelFormats;
		static inline std::vector<std::string> m_supportedShaderFormats;
		static inline std::vector<std::string> m_supportedScriptFormats;
		static inline std::vector<std::string> m_supportedFontFormats;
